...
//        CustomAlertView.shared.showCustomAlert(title: "Reset Password", message: "We will email you a magic link to reset your password.")
        presentCustomAlertOnMainThread(title: "Reset Password", message: "We will email you a magic link to reset your password.", buttonTitle: "Send Link", imageNamed: "message-Icon", arrowBtn: true)
    }
