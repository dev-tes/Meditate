...
extension OnboardingViewController {
    ...
    private func setupConstraints() {
        ...
        collectionView.anchorWithConstantsToTop(view.safeAreaLayoutGuide.topAnchor,
                                                left: view.leftAnchor, bottom: nextArrow.topAnchor, right: view.rightAnchor, topConstant: 50, leftConstant: 0, bottomConstant: 30, rightConstant: 0)
        NSLayoutConstraint.activate([
            nextArrow.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -100),
